    ...
    >
      <div className="max-w-xl px-8 py-12 rounded-lg add-bg">
        ...
        <div className="flex items-center justify-around w-full py-6 text-3xl rounded-xl">
          <a href="mailto:dasarchisman25@gmail.com">
            <SiGmail />
          </a>
          <a href="https://twitter.com/Arch_0125/" target="_blank" rel="noreferrer">
            <SiTwitter />
          </a>
          <a href="https://github.com/Arch0125/" target="_blank" rel="noreferrer">
            <SiGithub />
          </a>
        </div>
      </div>
